...
class StringField(Field):
    def __init__(self, name=None, primary_key=False, default=None, data_type='varchar(100)'):
...
class Model(dict, metaclass=ModelMetaclass):
    ...
    async def save(self):
        ...
        if rows != 1:
            logging.warn('faid to insert record: affected rows: %s' % rows)
...
if __name__ == '__main__':
    ...
    u = User(id=123, name='lijun', email='lijun@yy.com', password='password') 
    print(u)
    u.save()
    print(u)
