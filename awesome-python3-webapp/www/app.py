...
def init_jinja2(app, **kw):
    ...
    options = dict(
        ...
        variable_end_string = kw.get('variable_end_stirng', '}}'),
...
def datetime_filter(t):
    ...
    return u'%s y %s m %s d' % (dt.year, dt.month, dt.day)

async def init(loop):
    await orm.create_pool(loop=loop, host='127.0.0.1', port=3306, user='lijun', password='li999888', db='awesome')
